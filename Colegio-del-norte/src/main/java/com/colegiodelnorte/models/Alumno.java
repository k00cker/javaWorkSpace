...
public class Alumno {
	...
	@Schema(description = "Nombre del Alumno", requiredMode = Schema.RequiredMode.REQUIRED, example = "Felipe")
	@Column(name = "Nombre", nullable = false)
	private String nombre;

	@Schema(description = "Apellido del Alumno", requiredMode = Schema.RequiredMode.REQUIRED, example = "Menendez")
